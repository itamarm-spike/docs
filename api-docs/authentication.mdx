...
<Note>Include the **access_token** in the **Authorization** header for all API requests to Spike. The token should be prefixed with `Bearer`.**Authorization: Bearer \<access_token\>**</Note>
